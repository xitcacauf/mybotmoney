...
const PAGES = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "!namoro @user", value: "💕 Evoluir relação com alguém (conhecendo→namorando)" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "!desafio @user <texto>", value: "🎯 Enviar desafio personalizado — você escreve!" },
  ...
  },
  {
    title: "🏠 Vida Virtual",
    color: 0x27ae60,
    desc: "Casa, filhos, pet, duo e eventos — viva sua segunda vida!",
    fields: [
