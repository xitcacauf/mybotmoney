...
// Toda a inicialização dentro de uma IIFE async para não bloquear o event loop
(async () => {
    ...
    if (fs.existsSync(LOCK_FILE)) {
      ...
      if (oldPid && oldPid !== process.pid) {
        try {
          ...
          // Aguarda o processo antigo liberar o gateway — SEM bloquear o event loop
  ...
  // ── Remove listeners fantasmas deixados por restart parcial ─────────────────
  ...
  // ── Confirma contagem de listeners — deve ser exatamente 1 cada ─────────────
